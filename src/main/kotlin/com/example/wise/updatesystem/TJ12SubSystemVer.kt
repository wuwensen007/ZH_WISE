...
object TJ12SubSystemVer: SubSystemVer() {
    ...
    override fun getSubSystemLocalCsvPath(): String{
        return """${Constant.LOCAL_WISE_BASE_PATH}${File.separator}${Constant.TJ12PATH}${File.separator}${Constant.CSVNAME}"""
    }
    ...
    override fun getSubSystemLocalTempCsvPath(): String {
        return """${Constant.WISE_LOCAL_CSV_TEMP_DIR}${File.separator}${Constant.TJ12PATH}"""
    }
